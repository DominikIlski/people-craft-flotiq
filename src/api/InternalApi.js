...
export default class InternalApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/ContentTypeDefinitionSchema} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/ContentTypeDefinitionSchema}
     */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/ContentTypeListResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/ContentTypeListResponse}
     */
