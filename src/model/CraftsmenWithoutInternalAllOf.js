...
/**
 * The CraftsmenWithoutInternalAllOf model module.
 * @module model/CraftsmenWithoutInternalAllOf
 * @version 2.0.1
 */
class CraftsmenWithoutInternalAllOf {
    /**
     * Constructs a new <code>CraftsmenWithoutInternalAllOf</code>.
     * @alias module:model/CraftsmenWithoutInternalAllOf
     */
    constructor() { 
        
        CraftsmenWithoutInternalAllOf.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CraftsmenWithoutInternalAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CraftsmenWithoutInternalAllOf} obj Optional instance to populate.
     * @return {module:model/CraftsmenWithoutInternalAllOf} The populated <code>CraftsmenWithoutInternalAllOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CraftsmenWithoutInternalAllOf();
...
export default CraftsmenWithoutInternalAllOf;
