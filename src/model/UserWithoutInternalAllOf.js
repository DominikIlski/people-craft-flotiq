...
/**
 * The UserWithoutInternalAllOf model module.
 * @module model/UserWithoutInternalAllOf
 * @version 2.0.1
 */
class UserWithoutInternalAllOf {
    /**
     * Constructs a new <code>UserWithoutInternalAllOf</code>.
     * @alias module:model/UserWithoutInternalAllOf
     */
    constructor() { 
        
        UserWithoutInternalAllOf.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserWithoutInternalAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserWithoutInternalAllOf} obj Optional instance to populate.
     * @return {module:model/UserWithoutInternalAllOf} The populated <code>UserWithoutInternalAllOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserWithoutInternalAllOf();
...
export default UserWithoutInternalAllOf;
