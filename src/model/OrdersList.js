...
class OrdersList {
    ...
    constructor(totalCount, count, totalPages, currentPage) { 
        SystemListProperties.initialize(this, totalCount, count, totalPages, currentPage);OrdersListAllOf.initialize(this);
        OrdersList.initialize(this, totalCount, count, totalPages, currentPage);
    }
     ...
     * @param {module:model/OrdersList} obj Optional instance to populate.
     * @return {module:model/OrdersList} The populated <code>OrdersList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrdersList();
            SystemListProperties.constructFromObject(data, obj);
            OrdersListAllOf.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [Orders]);
            }
        }
        return obj;
    }
 ...
 */
OrdersList.prototype['total_count'] = undefined;
 ...
 */
OrdersList.prototype['total_pages'] = undefined;

/**
 * @member {Number} current_page
 */
OrdersList.prototype['current_page'] = undefined;

/**
 * @member {Array.<module:model/Orders>} data
 */
OrdersList.prototype['data'] = undefined;
...
// Implement OrdersListAllOf interface:
/**
 * @member {Array.<module:model/Orders>} data
 */
OrdersListAllOf.prototype['data'] = undefined;
