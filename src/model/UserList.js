...
import UserListAllOf from './UserListAllOf';
...
class UserList {
     ...
     * @implements module:model/UserListAllOf
    ...
    constructor(totalCount, count, totalPages, currentPage) { 
        SystemListProperties.initialize(this, totalCount, count, totalPages, currentPage);UserListAllOf.initialize(this);
        UserList.initialize(this, totalCount, count, totalPages, currentPage);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            UserListAllOf.constructFromObject(data, obj);
 ...
 */
UserList.prototype['total_count'] = undefined;

/**
 * @member {Number} count
 */
UserList.prototype['count'] = undefined;

/**
 * @member {Number} total_pages
 */
UserList.prototype['total_pages'] = undefined;

/**
 * @member {Number} current_page
 */
UserList.prototype['current_page'] = undefined;
...
// Implement UserListAllOf interface:
/**
 * @member {Array.<module:model/User>} data
 */
UserListAllOf.prototype['data'] = undefined;
