...
/**
 * The OrdersWithoutInternal model module.
 * @module model/OrdersWithoutInternal
 * @version 2.0.1
 */
class OrdersWithoutInternal {
    /**
     * Constructs a new <code>OrdersWithoutInternal</code>.
     * @alias module:model/OrdersWithoutInternal
    ...
    constructor(id, user, status, craftsman) { 
        AbstractContentTypeSchemaDefinitionWithoutInternal.initialize(this, id);OrdersWithoutInternalAllOf.initialize(this);
        OrdersWithoutInternal.initialize(this, id, user, status, craftsman);
    }
    ...
    /**
     * Constructs a <code>OrdersWithoutInternal</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrdersWithoutInternal} obj Optional instance to populate.
     * @return {module:model/OrdersWithoutInternal} The populated <code>OrdersWithoutInternal</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrdersWithoutInternal();
 ...
 * @member {String} id
 */
OrdersWithoutInternal.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/DataSource>} user
 */
OrdersWithoutInternal.prototype['user'] = undefined;

/**
 * @member {String} status
 */
OrdersWithoutInternal.prototype['status'] = undefined;

/**
 * @member {Array.<module:model/DataSource>} service
 */
OrdersWithoutInternal.prototype['service'] = undefined;

/**
 * @member {Array.<module:model/DataSource>} pictures
 */
OrdersWithoutInternal.prototype['pictures'] = undefined;

/**
 * @member {Number} quantity
 */
OrdersWithoutInternal.prototype['quantity'] = undefined;

/**
 * @member {Array.<module:model/DataSource>} craftsman
 */
OrdersWithoutInternal.prototype['craftsman'] = undefined;

/**
 * @member {String} description
 */
OrdersWithoutInternal.prototype['description'] = undefined;

/**
 * @member {Array.<module:model/DataSource>} masterpiece
 */
OrdersWithoutInternal.prototype['masterpiece'] = undefined;
...
export default OrdersWithoutInternal;
